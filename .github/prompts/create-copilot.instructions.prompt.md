...
description: Instructions Generator
---
...
The .md file should have frontmatter with a NAME, description property that informs copilot of when to use this set of instructions.
